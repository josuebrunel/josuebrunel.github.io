...
## XXI. Grid, Greedy, Knapsack & Trie Patterns

#### 227 — Matrix/Grid Traversal (Multi-source BFS / Flood Fill): how do you recognize it, and what does the template look like?
...
#### 228 — Greedy / Interval Scheduling: how do you recognize it, and what does the template look like?
...
#### 229 — 0/1 Knapsack (Subset-Sum DP): how do you recognize it, and what does the template look like?
...
#### 230 — Trie (Prefix Tree): how do you recognize it, and what does the template look like?
...
**[XXI. Grid, greedy, knapsack & trie patterns](#xxi-grid-greedy-knapsack--trie-patterns):** newer categories on this list, but no less common in practice. Grid BFS/DFS (227) shows up constantly in easy/medium rounds, it's really just Tree BFS (219) with up to 4 neighbors instead of 2 children. Knapsack (229) is the one people confuse with Subsequence DP (226): if your DP's second dimension is a running sum or capacity rather than a position in the sequence, you're in knapsack territory, not subsequence territory.
